...
## Addendum 2026-09-23 — restauración de historial + decisión vendored

Historial 2026-09-16/17 restaurado íntegro arriba (commit 2c1a2b8 lo había reducido a 4 líneas). Estado actual:
...
**Decisión (revisión thermo-nuclear 2026-09-23):** se levanta parcialmente el congelado Fase 4.5b de endored/simp.py SOLO para olfrac_mode (espejo del núcleo); simetría/Heaviside/extrusión/GCMMA siguen solo en core/topopt.py. Extracción de política canónica compartida (core/volume_policy.py) queda como propuesta registrada, no ejecutada (regla: modificación mínima).
