    ...
    def _on_run_optimization(self, params: dict) -> None:
        ...
        self.controller.run_in_background(
            lambda: self.controller.run_optimization(
                ...
                overhang_constraint=bool(params.get("overhang_constraint", False)),
                overhang_angle_deg=float(params.get("overhang_angle_deg", 45.0)),
                objective=str(params.get("objective", "min_compliance")),
                compliance_limit=params.get("compliance_limit"),
                heaviside_projection=bool(params.get("heaviside_projection", False)),
                heaviside_beta=float(params.get("heaviside_beta", 1.0)),
                heaviside_continuation=bool(params.get("heaviside_continuation", False)),
                extrusion_axis=params.get("extrusion_axis"),
                **thermal_kwargs,
            ),
