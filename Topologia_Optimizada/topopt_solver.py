"""Topological optimisation interface.

The previous implementation generated random displacements and forces.  That
is unsafe because it looked like a completed engineering result.  This module
now exposes a deterministic interface and refuses to run until a real FEA
adapter is supplied.
"""
...
NOT_IMPLEMENTED = "A real FEA solver and mapped boundary conditions are required"


class TopOptSolver:
    """Prepared SIMP interface; no fake analysis is performed."""
