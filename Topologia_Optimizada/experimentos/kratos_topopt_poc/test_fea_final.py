#!/usr/bin/env python3
"""
Script de prueba final con configuración corregida
"""
...
def test_final_configuration():
    ...
    try:
        ...
        # Importar la malla manualmente primero para evitar duplicación
        ...
        # Ejecutar inicialización (sin importar malla de nuevo)
        print("Inicializando análisis...")
        # Saltar la importación automática de malla ya que ya la importamos manualmente
        simulation._GetSolver().main_model_part = model_part
...
if __name__ == "__main__":
    success, results = test_final_configuration()
